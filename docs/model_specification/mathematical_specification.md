...
![Differential Model Specification](img/differential_model_specification.png)
...
![cadCAD Canvas Legend](img/cadcad_canvas_legend.png){h=500px}
...
![PSUB 1: Network Upgrade Stages](img/psub_1.png){h=500px}
...
![PSUB 2: Validator Process](img/psub_2.png){h=500px}
...
![PSUB 3: Ethereum Processes](img/psub_3.png){h=500px}
...
![PSUB 4: Base Reward](img/psub_4.png){h=500px}
...
![PSUBs 5 & 6: Attestation, Block Proposal & Sync Committee Rewards](img/psubs_5_6.png){h=500px}
...
![ETH rewards pie-chart](img/eth_rewards.png){h=300px}
...
![PSUB 7: Attestation & Sync Committee Penalties](img/psub_7.png){h=500px}
...
![PSUB 8: Validating Reward & Penalty Aggregation](img/psub_8.png){h=500px}
...
![PSUB 9: Slashing Rewards & Penalties](img/psub_9.png){h=500px}
...
![PSUB 10: EIP1559 Transaction Pricing](img/psub_10.png){h=500px}
...
![System Metrics](img/system_metrics.png){h=200px}
