...
def policy_validators(params, substep, state_history, previous_state):
    ...
    validators_uptime = validator_internet_uptime * validator_power_uptime * validator_technical_uptime
    ...
    number_of_validators_offline: int = number_of_validators - number_of_validators_online
...
def policy_average_effective_balance(params, substep, state_history, previous_state):
    ...
    total_effective_balance = eth_staked * constants.gwei - eth_staked * constants.gwei % effective_balance_increment
    max_total_effective_balance = max_effective_balance * number_of_validators

    average_effective_balance = min(total_effective_balance, max_total_effective_balance)
