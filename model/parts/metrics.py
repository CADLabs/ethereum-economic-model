...
def policy_validator_costs(params, substep, state_history, previous_state):
    ...
    validator_hardware_costs = (
        validator_count_distribution * validator_hardware_costs_per_epoch
    )
    validator_cloud_costs = (
        validator_count_distribution * validator_cloud_costs_per_epoch
    )
...
def policy_calculate_yields(params, substep, state_history, previous_state):
    ...
    validator_eth_staked = (
        validator_count_distribution * average_effective_balance / constants.gwei
    )
    validator_revenue = (
        validator_percentage_distribution
        * total_online_validator_rewards
